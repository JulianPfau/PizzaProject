...
function loadJSCONToTable() {
    var json = [{"name":"Salami Pizza","description":"A tasty meat Pizza","price":["5,99","7,99"],"size":["X","L"],"type":"Pizza","tags":["Meat","Pizza","Classic"]},{"name":"Cola","description":"Classic Coca Cola","price":["2,99","4,99"],"size":["0.33","0.5"],"type":"Getränk","tags":["Getränk","Cola","Classic"]}];
